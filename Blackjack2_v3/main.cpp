...
int main(int argc, char** argv) {
    ...
    {   if(phand[i] == 1)
        {   cout<<"You have an ace.\n";
            cout<<"Do you want your hand as "<<ptot<<" or "<<ptotace<<endl;
            cout<<"Enter the number you would like\n";
            cin>>totdec;
            if(totdec == ptotace)
            {   ptot = ptotace; }
        }
    ...
    {   cout<<"Dealer hits\n";
        ...
        cout<<"Dealer drew a "<<rank[getrank(dhand[dcard])]
              <<" of "<<suit[getsuit(dhand[dcard])]<<endl;
        
        dhand[dcard] = getrank(dhand[dcard]);
        dhand[dcard]++;
        if (dhand[dcard] > 10)
        { dhand[dcard] = 10; }
